...
df1 = pd.read_csv("config_bdd15000-20000_encoded_size.csv")
df2 = pd.read_csv("config_bdd20000-30000_encoded_size.csv")
df3 = pd.read_csv("config_bdd30000-40000_encoded_size.csv")
df4 = pd.read_csv("config_bdd40000-60000_encoded_size.csv")
df5 = pd.read_csv("config_bdd60000-90000_encoded_size.csv")
df6 = pd.read_csv("config_bdd90000-100000_encoded_size.csv")
df7 = pd.read_csv("config_bdd100000-1265000_encoded_size.csv")
...
df.to_csv("dataset_encoded_size.csv", index=False)